    ...
    for (let n = 0; n < 20; n++) {
      axios({
        ...
        data: {
          ...
          outer_id: ['가디건', '자켓', '얇은코트', '두꺼운코트', '패딩'][getRandomIntInclusive(0, 4)],
          top_id: ['민소매', '반팔', '긴팔', '셔츠', '니트'][getRandomIntInclusive(0, 4)],
          bottom_id: ['반바지', '긴바지'][getRandomIntInclusive(0, 1)],
    ...
    <Outer className='writePage'>
      <PictureSection className='pictureUploadSection writePageLeft' onSubmit={onSubmit}>
        <article className='titleInput'>
          <WriteText onChange={titleInputHandler} value={title} placeholder='제목을 입력하세요.' small></WriteText>
        </article>
