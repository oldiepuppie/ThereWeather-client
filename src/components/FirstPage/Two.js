...
export default function Two({ delayOne, delayTwo, delayThree, delayFour, delayFive }) {
  return (
    <TitleAndContents className={['landingPagePart', 'two']}>
      <AnimatedTitle delay={delayOne}>step 1</AnimatedTitle>
      <ContentsUnderTitle className='contents'>
        <HalfPage className='half-page' delay={delayTwo}>
          ...
          <div className='picture-png left'>
            <AnimatedImg src='img/firstpage/web_search.png' alt='web surfing' delay={delayThree} />
          </div>
        </HalfPage>

        <HalfPage className='half-page'>
          <div className='picture-png right'>
            <AnimatedImg src='img/firstpage/adventure_map.png' alt='walking' delay={delayFour} />
          </div>
