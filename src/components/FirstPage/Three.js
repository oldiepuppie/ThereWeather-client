...
export default function Three({ delayOne, delayTwo, delayThree, delayFour, delayFive }) {
  return (
    <TitleAndContents className={['landingPagePart', 'three']}>
      <AnimatedTitle delay={delayOne}>step 2</AnimatedTitle>
      <ContentsUnderTitle className='contents'>
        <HalfPage className='half-page'>
          ...
          <div className='picture-png left'>
            <AnimatedImg src='img/firstpage/photos.png' alt='photos' delay={delayThree} />
          </div>
        </HalfPage>
        ...
        <HalfPage className='half-page'>
          ...
          <TwoPictures className='picture-png right'>
            <AnimatedImg src='img/firstpage/mobile.png' alt='touching mobile phone' delay={delayFive} />
            <AnimatedImg src='img/firstpage/after_the_rain.png' alt='holding umbrella' delay={delayFive} />
          </TwoPictures>
        </HalfPage>
      </ContentsUnderTitle>
    </TitleAndContents>
