...
export default function Four({ delayOne, delayTwo, delayThree, delayFour, delayFive }) {
      ...
      <ContentsUnderTitle className='contents'>
        <HalfPage className='half-page'>
          ...
          <div className='picture-png left'>
            <AnimatedImg src='img/firstpage/destination.png' alt='reading mobile phone map' delay={delayThree} />
          </div>
        </HalfPage>
        <HalfPage className='half-page'>
          <TwoPictures className='picture-png right'>
            <AnimatedImg src='img/firstpage/publish_post.png' alt='publishing post' delay={delayFour} />
            <AnimatedImg src='img/firstpage/among_nature.png' alt='watching tree' delay={delayFour} />
          </TwoPictures>
